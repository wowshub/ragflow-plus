...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图的模块化检索增强生成 (RAG) 系统`,
    ...
    write: {
      ...
      saveCurrentAsTemplate: '保存当前内容为模板',
      delete: '删除',
      customTemplateMarker: '自定义模板',
      confirmDeleteTemplate: '确认删除模板?',
      cancel: '取消',
      confirm: '确认',
      saveAsCustomTemplateTitle: '保存为自定义模板',
      templateNameLabel: '模板名称',
      templateContentPreviewLabel: '模板内容预览',
      templateNameMessage: '模板名称是必填项',
      templateNamePlaceholder: '请输入模板名称',
      saveTemplate: '保存',
      templateDeletedSuccess: '模板删除成功',
      templateDeletedFailed: '模板删除失败',
